...
**时间**: 2026-06-01
**影响范围**: GroundPA-Toolkit Word skill (`workspace-setup.md`)
**类型**: Bug Fix (Skill)
...
Agent 将 `<skill-root>` 解析为包含插件版本号的绝对路径：`C:\Users\...\groundpa-toolkit\1.1.1\word\formats\...json`
...
- Plugin marketplace 的 GroundPA-Toolkit 需更新到包含此修复的版本
